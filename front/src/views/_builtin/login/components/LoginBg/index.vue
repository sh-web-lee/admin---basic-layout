<template>
  <div class="">
    <!-- <div class="absolute -right-300px -top-900px <sm:(-right-100px -top-1170px)">
      <corner-right :start-color="lightColor" :end-color="darkColor" />
    </div>
    <div class="absolute -left-200px -bottom-400px <sm:(-left-100px -bottom-760px)">
      <corner-left :start-color="darkColor" :end-color="lightColor" />
    </div> -->
    <div class="absolute -bottom-10px left-260px">
      <circle-blur />
    </div>
  </div>
</template>
...
import { CircleBlur } from './components'
